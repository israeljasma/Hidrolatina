...
def loadEfficient():
    ...
    model_ed.load_state_dict(torch.load('E:/Users/darkb/OneDrive/Documentos/EIE/Tesis/Pruebas_de_codigos/Yet-Another-EfficientDet-Pytorch/logs/person_coco/efficientdet-d2_58_8260_best.pth'))
...
def loadClip():
    ...
    candidate_captions={'im_head': [['a head with a yellow helmet','Just a head'], ['Head with headphones', 'Just a head'],['a Head with goggles', 'Just a head'],['Head with a medical mask', 'Just a head']],
                ...
                'im_boot':[['A large black boot', 'A shoe']]}
...
root.iconbitmap("E:/Users/darkb/OneDrive/Documentos/EIE/Tesis/Hidrolatina/HidroLatina.ico")
...
def showPytorchCameraTk():
    ...
    image = PhotoImage(file="E:/Users/darkb/OneDrive/Documentos/EIE/Tesis/Hidrolatina/white-image.png")
    ...
    def updateLabelTest():
        ...
        image = PhotoImage(file="E:/Users/darkb/OneDrive/Documentos/EIE/Tesis/Hidrolatina/logo-sm.png")
        original_image = image.subsample(1,1)
...
def ReadNFC(res):
    ...
    while True:
        ...
        try:
            ...
            get_uid = util.toBytes("44 CE 4A 0B")
...
testButton2 = Button(root, text='Inicio',command=nfc_identify, fg='green').pack()
# MDETRButton = Button(root, text='MDETR', command=MDETR).pack()
# clipButton = Button(root, text='Clip', command=clip).pack()
# CameraButton = Button(root, text='Camara EfficientDet', command=pytorchCamera).pack()
